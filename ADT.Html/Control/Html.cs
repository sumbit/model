...
namespace ADT.Html.Control
{
    ...
    public class Html
    {
        ...
        /// <param name="Attribute">标签额外属性</param>
        /// <param name="Col">样式宽度</param>
        /// <param name="Validform">Validform验证框架名字</param>
        /// <returns></returns>
        public string Input(string Title, string Name, object Attribute = null, int Col = 6, string Validform = null, string nullmsg = null, string errormsg = null)
        {
            ...
            {
                _Input_Attribute.Add("datatype", Validform);
                _Input_Attribute.Add("nullmsg", nullmsg ?? $"请填写{Title}");
                if (!string.IsNullOrEmpty(errormsg))
                    _Input_Attribute.Add("errormsg", errormsg);
            }
        ...
        public string Select(string Title, object Attribute, Func<string> FuncOpetion, int Col = 6)
        {
            ...
            var Options = "<option value=\"-1\">==请选择 " + Title + "==</option>";
            Options += FuncOpetion();
        ...
        public string FindBack(string Title, string Text, string ID, string Url, string FindClick, string RemoveClick, int Col = 6, string Placeholder = null, bool KO = true, bool Readonly = true)
        {
            ...
            sb.Append("<div class=\"col-sm-" + Col + " t_" + Text + "\">");
            ...
            sb.Append("        <input type=\"text\" class=\"form-control hide\" name=\"" + ID + "\" " + _ID_KoHtml + "/>");
        ...
        /// <returns></returns>
        public string UploadImage(string Title, string Name, string Tips, int Col)
        {
            //<div class="col-sm-6">
            ...
            StringBuilder sb = new StringBuilder();
            sb.Append("<div class=\"col-sm-" + Col + " t_" + Name + "\">");
            sb.Append("    <h4 class=\"example-title\">" + Title + "</h4>");
        ...
        /// <param name="Height"></param>
        /// <returns></returns>
        public string UploadFileAsync(string Title, string Name, string Tips, int Col)
        {
            ...
            sb.Append("        <div class=\"hzy-upfile-item\">");
            sb.Append("        </div>");
            sb.Append($"        <input type=\"hidden\" name=\"{Name}\" data-bind=\"value:{Name}\" />");
            sb.Append($"        <div class=\"hzy-upfile-shade\" id=\"{Name}\">{Tips}</div>");
            sb.Append("    </div>");
            sb.Append("</div>");
            return sb.ToString().Trim();
        }
        ...
        /// <returns></returns>
        public string Textarea(string Title, string Name, int Col, object Attribute, string Placeholder, string Validform = null, string nullmsg = null, string errormsg = null)
        {
            //<div class="col-sm-6">
            ...
            if (!string.IsNullOrEmpty(Validform))
            {
                _Textarea_Attribute.Add("datatype", Validform);
                _Textarea_Attribute.Add("nullmsg", nullmsg ?? $"请填写{Title}");
                if (!string.IsNullOrEmpty(errormsg))
                    _Textarea_Attribute.Add("errormsg", errormsg);
            }
